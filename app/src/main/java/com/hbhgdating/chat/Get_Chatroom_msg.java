 ...
 */
public class Get_Chatroom_msg  extends AppCompatActivity {
    ...
    String user_details;
    String chatroom_admin_id, video_link , chatroom_id;
    int image_type;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Get_Chatroom_msg.this.registerReceiver(mMessageReceiver, new IntentFilter(Common.Key_GroupChat));
    ...
    private void initViews(){
        ...
        if (bundle != null){
            ...
            name_chatroom = bundle.getString("chatroom_title");

            textView_chatroom.setText(name_chatroom);
            textView_tag.setText(bundle.getString("tags"));
            chatroom_admin_id = bundle.getString("user_id");
            image_type = Integer.parseInt(bundle.getString("content_type"));
            video_link = bundle.getString("content_video");
            String[] array = bundle.getString("admin_name").split(" ");
            tv_created_by_name.setText(array[0]);
            chatroom_id = getIntent().getStringExtra("id");

            global_class.setChatting_chatroom_id(chatroom_id);
            databaseHelper.update_isNewMsg_TABLE_MY_CHATROOM(chatroom_id);
            databaseHelper.update_isNeweF_CHATROOM(chatroom_id);

            if (image_type == 2){
                Picasso.with(getApplicationContext()).load(bundle.getString("content_img")).error(R.mipmap.grid_bg_3).into( img1, new Callback() {
                    @Override
                ...
                Picasso.with(getApplicationContext()).load(bundle.getString("content_video_img")).error(R.mipmap.grid_bg_3).into( img1, new Callback() {
                    @Override
                    public void onSuccess() {
                        //  Log.d("TAG", "onSuccess");
                    }
           ...
           // Log.d(All_Constants_Urls.TAG, ""+bundle.getString("content_video_img"));
            ...
            imgPlay.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(Get_Chatroom_msg.this, ChatroomVideoImg.class);
                    intent.putExtra("content_type", image_type);
                    intent.putExtra("content_video", video_link);
                    intent.putExtra("content_img", bundle.getString("content_img"));
        ...
        imgSticker.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1 = new Intent(Get_Chatroom_msg.this, StickersView.class);
    ...
    public void getGiphy(String keywoard){
        ...
        if (conMgr.getNetworkInfo(ConnectivityManager.TYPE_WIFI).getState() == NetworkInfo.State.CONNECTED
                        ...
                        if (response != null) {
                            try {
                              ...
                              //  Log.d("response", response.toString());
                                ...
                                GiphyAdapter_Chatroom giphyAdapter = new GiphyAdapter_Chatroom(Get_Chatroom_msg.this, array_list,arrData,adapter,chatroom_id);
            ...
            AlertDialog alert1 = new AlertDialog.Builder(Get_Chatroom_msg.this).create();
    ...
    public void getUserList() {
        ...
        if (conMgr.getNetworkInfo(ConnectivityManager.TYPE_WIFI).getState() == NetworkInfo.State.CONNECTED
            ...
            params.put(All_Constants_Urls.Token, All_Constants_Urls.TOKEN_FIXED);
            params.put(All_Constants_Urls.user_id, sharedPref.get_Use_Id());
            params.put(All_Constants_Urls.chatroom_id, getIntent().getStringExtra("id"));
            final AsyncHttpClient client = new AsyncHttpClient();
                            ...
                            try {
                              //  Log.d("response", response.toString());
                                ...
                                if (status == 0){
                                    ...
                                    Intent intent = new Intent(Get_Chatroom_msg.this, ChatroomMembersActivity.class);
    ...
    public void setChatData(String chatData){
        ...
        // Log.d(All_Constants_Urls.TAG, "chatData = "+chatData);
