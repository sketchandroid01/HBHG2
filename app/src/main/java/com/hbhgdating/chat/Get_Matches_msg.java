...
public class Get_Matches_msg extends AppCompatActivity {

    TextView textView, empty;
    CountDownTimer timer;

    String name_user ="", to_user_id;
    ListView listView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Get_Matches_msg.this.registerReceiver(mMessageReceiver,
                new IntentFilter(Common.Key_SingleChat));
    ...
    public void initViews(){
        ...
        defaultOptions = new DisplayImageOptions.Builder()
                .showImageOnLoading(R.mipmap.grid_bg_3) // resource or drawable
                .showImageForEmptyUri(R.mipmap.grid_bg_3) // resource or drawable
                .showImageOnFail(R.mipmap.grid_bg_3) // resource or drawable
            ...
            public void onClick(View v) {
                ...
                if (!edt_message.getText().toString().isEmpty()){
                    ...
                    if (ConnectivityReceiver.isConnected()){
                        ...
                        Toast.makeText(Get_Matches_msg.this, "Please connect to internet", Toast.LENGTH_SHORT).show();
                    }
        ...
        imgSticker.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1 = new Intent(Get_Matches_msg.this, StickersView.class);
    ...
    public void sendTextMessage() {
        ...
        if (!message.equalsIgnoreCase("")) {
            final ChatMessage chatMessage = new ChatMessage("text","me",
                    "test",true);
            chatMessage.body = message;
            chatMessage.Date = dateFormat.format(today);
    ...
    public  void getGiphy(String keywoard){
        ...
        if (conMgr.getNetworkInfo(ConnectivityManager.TYPE_WIFI).getState() == NetworkInfo.State.CONNECTED
          ...
          //  Log.d(TAG, "gif url = "+url);
                        ...
                        if (response != null) {
                            try {
                             ...
                             //   Log.d("response", response.toString());
                                ...
                                GiphyAdapter giphyAdapter = new GiphyAdapter(Get_Matches_msg.this, array_list,arrData,adapter,to_user_id);
            ...
            AlertDialog alert1 = new AlertDialog.Builder(Get_Matches_msg.this).create();
                ...
                if (response != null) {
                    try {
                        ...
                        if (success == 0){
                          ...
                          /*  android.app.AlertDialog alert = new android.app.AlertDialog.Builder(Get_Matches_msg.this).create();
