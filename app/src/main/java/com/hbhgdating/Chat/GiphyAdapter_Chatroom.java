...
public class GiphyAdapter_Chatroom extends RecyclerView.Adapter<GiphyAdapter_Chatroom.ViewHolder> {
    ...
    public GiphyAdapter_Chatroom(Context context, ArrayList<HashMap<String,String>> final_list, ArrayList<ChatMessage> arrData, ChatRoomDetailListViewAdapter adapter, String id) {
        super();
    ...
    public void postchat(String content){
        ...
        URL = All_Constants_Urls.postonchatroom;
        ...
        params.put(All_Constants_Urls.chatroom_id, recieverid);
